...
import com.application.ogawadev.domain.restaurante.SearchFilter.Order;
...
public class RestauranteComparator implements Comparator<Restaurante>{
	...
	public int compare(Restaurante r1, Restaurante r2) {
		...
		if( filter.getOrder() == Order.Taxa ) {
			...
			throw new IllegalStateException("O valor de ordenacao " + filter.getOrder() + " nao e valido");
